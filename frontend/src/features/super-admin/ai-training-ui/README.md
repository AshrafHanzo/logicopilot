# AI Prompt Training Loop & Correction UI (frontend)
...
feature: `backend/app/modules/super_admin/ai_training_ui/README.md`.

## What's in this folder

- `AiTrainingUiPage.jsx` — the page component (currently a placeholder card).
