# AI Transformation Prompt Editor (frontend)
...
feature: `backend/app/modules/super_admin/ai_prompt_editor/README.md`.

## What's in this folder

- `AiPromptEditorPage.jsx` — the page component (currently a placeholder card).
