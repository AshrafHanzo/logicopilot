...
feature: `backend/app/modules/super_admin/label_builder/README.md`.

## What's in this folder

- `LabelBuilderPage.jsx` — the page component (currently a placeholder card).
